        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mb-4">
              ...
              pour vous aider à surmonter les épreuves de la vie et à mieux vous
              comprendre. <br />
              <br />
              Le bien-être de mes patients est ma priorité. J’attache une grande
              importance à l’accueil et à la qualité d’écoute. <br />
              <br />
